...
<body>
    <header>
        <h1>Openbare toiletten in jouw buurt</h1>
        <?php include '../includes/nav.php'; ?>
    </header>

    <main>
        <p class="intro">Vind schone en toegankelijke toiletten waar je snel terechtkunt.</p>
        <ul class="voorzieningen">
            <li>Toilet Stadhuisplein Schoon, Toegankelijk, Gratis</li>
            <li>Toilet Park Noord Betaald (€1), Niet-toegankelijk</li>
        </ul>
